...
#
# Usage:
#   irm https://raw.githubusercontent.com/matr1xp/hermes-agent/main/scripts/install.ps1 | iex
#
...
$RepoUrlSsh = "git@github.com:matr1xp/hermes-agent.git"
$RepoUrlHttps = "https://github.com/matr1xp/hermes-agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Install-Repository {
    ...
    if (Test-Path $InstallDir) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/matr1xp/hermes-agent/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/matr1xp/hermes-agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
